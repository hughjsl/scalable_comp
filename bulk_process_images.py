...
# -*- coding: utf-8 -*-
"""
    applies pre-processing steps to images in bulk
"""
...
# paths
IN_DIR  = Path("real_captchas")
OUT_DIR = Path("real_captchas_processed")
...
def main():
    ...
    print(f"Processing {len(files)} images from {IN_DIR} to {OUT_DIR}")
